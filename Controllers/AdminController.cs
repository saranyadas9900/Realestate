...
namespace WebApplication4.Controllers
{
...

    {
        ...
        {
            if (Session["Admin"] == null && filterContext.ActionDescriptor.ActionName != "Login")
            {
                // Redirect to Login page if session is null and the current action is not the Login action
